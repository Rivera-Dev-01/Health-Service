...
const translations: Record<Language, Record<string, string>> = {
    en: {
        ...
        "about.mission.p1": "Through accessible online platform, we strive to promote health awareness, encourage preventive care, and support healthy lifestyle choices. By empowering individuals with knowledge, we hope to improve overall wellness, reduce the risk of disease, and build a more informed and health-conscious community.",
        ...
        "about.serve.subtitle": "Care Cures provides trusted health information for everyone seeking to understand their health better.",
        "about.students.title": "For Student Nurses",
        "about.students.desc": "Strengthen your understanding of different health conditions and nursing care. Learn what to assess, what to monitor, and how to respond in patient situations.",
        "about.students.feature1": "Clinical references",
        "about.students.feature2": "Patient assessment guides",
    ...
    tl: {
        ...
        "about.mission.p1": "Sa pamamagitan ng accessible na online platform, nagsusumikap kaming itaguyod ang kamalayan sa kalusugan, hikayatin ang preventive care, at suportahan ang malusog na pamumuhay. Sa pamamagitan ng pagbibigay-kapangyarihan sa mga indibidwal gamit ang kaalaman, umaasa kaming mapabuti ang pangkalahatang wellness, mabawasan ang panganib ng sakit, at bumuo ng mas may kaalaman at health-conscious na komunidad.",
        ...
        "about.serve.title": "Sino ang Aming Pinagsisilbihan",
        "about.serve.subtitle": "Ang Care Cures ay nagbibigay ng pinagkakatiwalaang impormasyon sa kalusugan para sa lahat ng naghahanap ng pag-unawa sa kanilang kalusugan.",
        "about.students.title": "Para sa mga Estudyanteng Nars",
        "about.students.desc": "Palakasin ang iyong pag-unawa sa iba't ibang kondisyon sa kalusugan at nursing care. Matuto kung ano ang dapat suriin, ano ang dapat bantayan, at paano tumugon sa mga sitwasyon ng pasyente.",
        "about.students.feature1": "Mga clinical reference",
        "about.students.feature2": "Mga gabay sa patient assessment",
